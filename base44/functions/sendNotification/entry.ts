...
const PREF_MAP = {
  ...
  cleaning_job_move_requested: "jobs",
  cleaning_job_move_approved: "jobs",
  cleaning_job_move_denied: "jobs",
  cleaning_job_cancelled_by_cleaner: "jobs",
  cleaning_job_cancelled_by_host: "jobs",
