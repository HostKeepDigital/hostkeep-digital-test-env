...
import { CheckCircle, AlertTriangle, Loader2, ArrowLeft, Users, Star, Shield } from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[75vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#1E3A5F]/97 via-[#162d4a]/85 to-[#1d4ed8]/40" />
        </div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-8 pb-16 w-full">
          ...
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 border border-blue-400/50 bg-blue-400/10 rounded-full px-4 py-1.5 mb-5">
              <Users className="w-3.5 h-3.5 text-blue-400" />
              <span className="text-blue-400 text-xs font-semibold tracking-widest uppercase">Founding Cleaner Application</span>
            </div>
            ...
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-7 py-4 rounded-xl transition-colors"
            >
      ...
      <section className="bg-white py-12 border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <p className="text-center text-xs font-semibold text-gray-400 tracking-widest uppercase mb-8">What platforms cost you</p>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <p className="text-xs font-semibold text-blue-600 tracking-widest uppercase mb-3">Platform comparison</p>
            <h2 className="text-3xl font-bold text-gray-900">Where does your money go?</h2>
          </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-100">
                    ...
                    <th className="px-4 py-4 text-center bg-blue-50/60"><span className="text-xs font-semibold text-blue-600 uppercase tracking-wider">CleanKeep</span></th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-50">
                  {PLATFORMS.map(row => (
                    <tr key={row.label} className="hover:bg-gray-50/50">
                      ...
                      <td className="px-4 py-3 text-center text-xs text-red-600 font-medium">{row.agency}</td>
                      <td className="px-4 py-3 text-center text-xs text-orange-600 font-medium">{row.bark}</td>
                      <td className="px-4 py-3 text-center text-xs text-purple-600 font-medium">{row.taskrabbit}</td>
                      <td className="px-4 py-3 text-center text-xs text-blue-600 font-bold bg-blue-50/40">{row.hostkeep}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-gray-900">How CleanKeep works.</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {HOW_IT_WORKS.map(({ step, title, body }) => (
              <div key={step} className="text-center p-6 bg-gray-50 rounded-2xl">
                <p className="text-5xl font-black text-blue-100 mb-3">{step}</p>
      ...
      <section className="bg-[#1E3A5F] py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 bg-blue-500/15 border border-blue-400/30 rounded-full px-4 py-1.5 mb-4">
              <Star className="w-3.5 h-3.5 text-blue-400" fill="currentColor" />
              <span className="text-blue-400 text-xs font-semibold tracking-wider uppercase">Founding Cleaner Benefits</span>
            </div>
            <h2 className="text-3xl font-bold text-white mb-2">
              <span className="text-blue-400">3 months free.</span> Then from £9.99/month.
            </h2>
      ...
      <section ref={formRef} className="bg-white py-16">
        <div className="max-w-xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Apply for a founding cleaner spot</h2>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
              ...
              {[
                ...
                <div key={key}>
                  ...
                  <input
                    ...
                    className={`w-full border rounded-xl px-3 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500 transition-colors ${errors[key] ? "border-red-300" : "border-gray-200"}`}
                  />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full border rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500 transition-colors ${errors.email ? "border-red-300" : "border-gray-200"}`}
              />
            ...
            <div>
              ...
              <input
                ...
                placeholder="TR1 1AA"
                className={`w-full border rounded-xl px-4 py-3 text-sm uppercase focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500 transition-colors ${errors.postcode || cornwallWarn ? "border-amber-400" : "border-gray-200"}`}
              />
            ...
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white font-bold text-sm rounded-xl py-4 transition-colors flex items-center justify-center gap-2"
            >
              {submitting
