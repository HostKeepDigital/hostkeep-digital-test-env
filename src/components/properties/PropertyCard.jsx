  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`bg-white rounded-2xl overflow-hidden flex flex-col h-full border border-gray-100 transition-shadow ${
      ...
      >
        ...
        >
          ...
          {property.featured && (
            <Badge className="absolute top-3 left-3 bg-amber-500 border-0 shadow-sm z-20">
              Featured
            </Badge>
          )}
            ...
            {(property.pets_allowed || property.children_allowed) && (
              <div className="flex flex-wrap justify-end gap-1">
                {property.pets_allowed && (
                  <Badge
                    variant="secondary"
                    className="bg-white/90 text-xs border-0 shadow-sm"
                  >
                    Pet-friendly
                  </Badge>
                )}
          ...
          <div className="bg-amber-50 border-t border-amber-100 p-3 text-xs text-amber-900 mt-auto">
            ...
            {property.suggestion.conflictDates && (
              <p className="font-semibold text-amber-800 mb-2">
                {format(
                  parseISO(property.suggestion.conflictDates.start),
                  "MMM do"
                )}{" "}
                -{" "}
                {format(
                  parseISO(property.suggestion.conflictDates.end),
                  "MMM do, yyyy"
                )}
              </p>
            )}
            ...
            {property.suggestion.options &&
            property.suggestion.options.length > 0 ? (
