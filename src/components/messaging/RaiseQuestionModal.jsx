...
export default function RaiseQuestionModal({
  isOpen,
  onClose,
  booking,
  guestUser,
      ...
      <DialogContent>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={subject} onValueChange={setSubject}>
              ...
              <SelectContent>
                <SelectItem value="Check-in / Check-out">
                  Check-in / Check-out
                </SelectItem>
                ...
                <SelectItem value="Property Details">
                  Property Details
                </SelectItem>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={
              !subject || !message.trim() || sendMessageMutation.isPending
            }
          >
